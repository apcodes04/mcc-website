  ...
  return (
    <div className="py-20 px-8 max-w-6xl mx-auto">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold text-[#1E1A18] mb-6">Contact Us</h1>
      ...
      <div className="grid grid-cols-2 gap-16">
        {/* Contact Info */}
        <div className="bg-[#1E1A18] text-white p-12 rounded-2xl shadow-xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#6B5B4E] rounded-full opacity-20 -mr-20 -mt-20"></div>
          <h2 className="text-3xl font-bold mb-8 relative z-10 text-[#C8A97E]">Contact Information</h2>
          <div className="space-y-8 relative z-10">
            <div className="flex items-start gap-4">
              <Phone size={28} className="text-[#C8A97E] mt-1" />
              <div>
            ...
            <div className="flex items-start gap-4">
              <Mail size={28} className="text-[#C8A97E] mt-1" />
              <div>
            ...
            <div className="flex items-start gap-4">
              <MapPin size={28} className="text-[#C8A97E] mt-1" />
              <div>
        ...
        {/* Contact Form */}
        <div className="bg-[#FAF6F0] p-10 rounded-2xl shadow-xl border border-gray-100">
          <h2 className="text-3xl font-bold text-[#1E1A18] mb-8">Request a Proposal</h2>
          ...
          {submitted ? (
            <div className="bg-green-50 text-green-800 p-6 rounded-lg border border-green-200 text-center">
              ...
              <button onClick={() => setSubmitted(false)} className="mt-4 text-[#6B5B4E] underline">Submit another request</button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" className="w-full bg-[#6B5B4E] hover:bg-[#1E1A18] text-white font-bold py-4 rounded-lg transition-colors flex justify-center items-center gap-2">
