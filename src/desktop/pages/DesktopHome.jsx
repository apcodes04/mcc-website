...
export default function DesktopHome() {
  const services = [
    { title: "Residential Building", icon: <Home size={32} className="text-[#C8A97E]" /> },
    { title: "Turnkey Projects", icon: <Building size={32} className="text-[#C8A97E]" /> },
    { title: "RCC Structural Work", icon: <Hammer size={32} className="text-[#C8A97E]" /> },
    { title: "Renovation & Redevelopment", icon: <HardHat size={32} className="text-[#C8A97E]" /> },
  ];
    ...
    <div>
      ...
      <section className="relative h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-20 text-center text-white px-4 max-w-4xl">
          ...
          <div className="flex justify-center gap-4">
            <Link to="/contact" className="bg-[#C8A97E] hover:bg-[#a6823a] text-white px-8 py-3 rounded-md font-semibold transition-all transform hover:scale-105 flex items-center gap-2">
              Request a Proposal <ArrowRight size={20} />
            </Link>
            <Link to="/about" className="bg-[#FAF6F0]/20 hover:bg-[#FAF6F0]/30 backdrop-blur-sm border border-[#FAF6F0]/50 text-white px-8 py-3 rounded-md font-semibold transition-all">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-8 max-w-6xl mx-auto flex items-center gap-16">
        <div className="flex-1">
          <h2 className="text-4xl font-bold text-[#1E1A18] mb-6">Expertise You Can Build On</h2>
          ...
          <ul className="space-y-3 mb-8">
            <li className="flex items-center gap-3 text-gray-700 font-medium"><CheckCircle2 className="text-[#C8A97E]" /> End-to-End Execution</li>
            <li className="flex items-center gap-3 text-gray-700 font-medium"><CheckCircle2 className="text-[#C8A97E]" /> Project Planning & Execution</li>
            <li className="flex items-center gap-3 text-gray-700 font-medium"><CheckCircle2 className="text-[#C8A97E]" /> Site Supervision & Coordination</li>
          </ul>
        </div>
        <div className="flex-1 relative">
          <img src="/images/mcc about us.jpg" alt="About MCC" className="rounded-xl shadow-2xl" />
          <div className="absolute -bottom-6 -left-6 bg-[#6B5B4E] text-white p-6 rounded-lg shadow-xl">
      ...
      {/* Services Grid */}
      <section className="bg-[#F0EAE1] py-20 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#1E1A18] mb-4">Our Services</h2>
          ...
          <div className="grid grid-cols-4 gap-8">
            {services.map((srv, idx) => (
              <div key={idx} className="bg-[#FAF6F0] p-8 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-2 border border-gray-100 group">
                <div className="mb-6 p-4 bg-[#FAF6F0] rounded-full inline-block group-hover:bg-[#C8A97E]/10 transition-colors">
                  {srv.icon}
                </div>
                <h3 className="text-xl font-bold text-[#1E1A18] mb-3">{srv.title}</h3>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#1E1A18] mb-4">Ongoing Projects</h2>
