...
export default function MobileHome() {
  const services = [
    { title: "Residential Building", icon: <Home size={28} className="text-[#C49A45]" /> },
    { title: "Turnkey Projects", icon: <Building size={28} className="text-[#C49A45]" /> },
    { title: "RCC Structural Work", icon: <Hammer size={28} className="text-[#C49A45]" /> },
    { title: "Renovation", icon: <HardHat size={28} className="text-[#C49A45]" /> },
  ];
    ...
    <div>
      ...
      <section className="relative h-[500px] flex items-center justify-center">
        ...
        <div className="relative z-20 text-center text-white px-6 w-full">
          <h1 className="text-4xl font-bold mb-4 drop-shadow-lg">Building Strength,<br/><span className="text-[#C49A45]">Delivering Trust</span></h1>
          ...
          <div className="flex flex-col gap-4">
            <Link to="/contact" className="bg-[#C49A45] hover:bg-[#a6823a] text-white px-6 py-3 rounded-md font-semibold transition-all flex items-center justify-center gap-2">
              Request Proposal <ArrowRight size={20} />
            </Link>
            <Link to="/about" className="bg-white/20 backdrop-blur-sm border border-white/50 text-white px-6 py-3 rounded-md font-semibold transition-all">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <h2 className="text-3xl font-bold text-[#3E2723] mb-4 text-center">Expertise You Can Build On</h2>
        ...
        <div className="mb-10">
          <ul className="space-y-4">
            <li className="flex items-center gap-3 text-gray-700 font-medium bg-[#FDFBF7] p-4 rounded-lg shadow-sm border border-gray-100">
              <CheckCircle2 className="text-[#C49A45] flex-shrink-0" /> End-to-End Execution
            </li>
            <li className="flex items-center gap-3 text-gray-700 font-medium bg-[#FDFBF7] p-4 rounded-lg shadow-sm border border-gray-100">
              <CheckCircle2 className="text-[#C49A45] flex-shrink-0" /> Project Planning
            </li>
            <li className="flex items-center gap-3 text-gray-700 font-medium bg-[#FDFBF7] p-4 rounded-lg shadow-sm border border-gray-100">
              <CheckCircle2 className="text-[#C49A45] flex-shrink-0" /> Site Supervision
            </li>
          </ul>
        </div>
        ...
        <div className="relative mt-8">
          ...
          <div className="absolute -bottom-4 -left-4 bg-[#8B5E34] text-white p-4 rounded-lg shadow-xl border-2 border-white">
      ...
      <section className="bg-[#F8F5F0] py-16 px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#3E2723] mb-3">Our Services</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          {services.map((srv, idx) => (
            <div key={idx} className="bg-white p-6 rounded-xl shadow-sm text-center border border-gray-100">
              <div className="mb-4 p-3 bg-[#FDFBF7] rounded-full inline-block">
                {srv.icon}
              </div>
              <h3 className="text-md font-bold text-[#3E2723] leading-tight">{srv.title}</h3>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#3E2723] mb-3">Ongoing Projects</h2>
