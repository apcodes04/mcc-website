  ...
  return (
    <div className="py-12 px-6">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-[#1E1A18] mb-4">About Us</h1>
      ...
      <div className="mb-12 flex flex-col items-center">
        <img src="/images/mcclogo.jpg" alt="Company Logo" className="w-full max-w-[250px] mx-auto shadow-sm rounded-lg p-6 bg-[#FAF6F0] mb-6" />
        <div className="bg-[#FAF6F0] border border-[#C8A97E]/30 p-4 rounded-lg text-center shadow-sm w-full max-w-[250px] mb-8">
          <p className="text-[#6B5B4E] font-semibold text-sm italic">
      ...
      <div className="grid grid-cols-2 gap-4 mb-16">
        <div className="bg-[#F0EAE1] p-6 rounded-xl text-center border-b-4 border-[#C8A97E]">
          <Briefcase size={32} className="mx-auto text-[#6B5B4E] mb-3" />
          <h3 className="font-bold text-md mb-1">Industry</h3>
          <p className="text-gray-600 text-sm">Construction</p>
        </div>
        <div className="bg-[#F0EAE1] p-6 rounded-xl text-center border-b-4 border-[#C8A97E]">
          <Users size={32} className="mx-auto text-[#6B5B4E] mb-3" />
          <h3 className="font-bold text-md mb-1">Size</h3>
          <p className="text-gray-600 text-sm">15-20 Employees</p>
        </div>
        <div className="bg-[#F0EAE1] p-6 rounded-xl text-center border-b-4 border-[#C8A97E]">
          <Target size={32} className="mx-auto text-[#6B5B4E] mb-3" />
          <h3 className="font-bold text-md mb-1">Specialties</h3>
          <p className="text-gray-600 text-sm">Bungalows, Towers</p>
        </div>
        <div className="bg-[#F0EAE1] p-6 rounded-xl text-center border-b-4 border-[#C8A97E]">
          <MapPin size={32} className="mx-auto text-[#6B5B4E] mb-3" />
      ...
      {/* Leadership Section */}
      <div className="mb-12">
        <h2 className="text-3xl font-bold text-[#1E1A18] text-center mb-10">Our Leadership</h2>
        
        {/* Founder */}
        <div className="flex flex-col items-center mb-12 bg-[#E6D3A9] p-6 rounded-2xl shadow-md border border-transparent">
          <img src="/images/mahindra.jpg" alt="Mr. Mahendra Umbarkar" className="w-48 h-48 object-cover rounded-2xl shadow-md border-4 border-white mb-6" />
          <h3 className="text-2xl font-bold text-[#5C3317] text-center">Mr. Mahendra Umbarkar</h3>
          <p className="text-[#5C3317] font-bold text-center">Founder & Director</p>
          <p className="text-sm text-[#5C3317]/90 font-bold text-center mt-2 mb-6">B.E. M.I.E Civil</p>
          
          <div className="text-center">
            <p className="text-[#3E2723] leading-relaxed mb-4 text-sm">
            ...
            <p className="text-[#3E2723] leading-relaxed font-bold text-sm">
        ...
        {/* Project Manager */}
        <div className="flex flex-col items-center bg-[#E6D3A9] p-6 rounded-2xl shadow-md border border-transparent">
          <img src="/images/omkar.jpg" alt="Mr. Omkar Umbarkar" className="w-48 h-48 object-cover rounded-2xl shadow-md border-4 border-white mb-6" />
          <h3 className="text-2xl font-bold text-[#5C3317] text-center">Mr. Omkar Umbarkar</h3>
          <p className="text-[#5C3317] font-bold text-center">Project Manager</p>
          <p className="text-sm text-[#5C3317]/90 font-bold text-center mt-2 mb-4">MBA - Marketing</p>
